...
class KNearestNeighbor:
  ...
  def compute_distances_one_loop(self, X):
    ...
    for i in xrange(num_test):
      ...
      #######################################################################
      X_test = np.resize(X[i], (X.shape[1], 1)) 
      dists[i] = np.sqrt(sum((np.transpose(self.X_train) - X_test)**2))
      #######################################################################
      #                         END OF YOUR CODE                            #
      #######################################################################
    return dists
  ...
  def compute_distances_no_loops(self, X):
    ...
    dists += sum((np.transpose(self.X_train))**2)
    dists = np.transpose(np.transpose(dists) + sum((np.transpose(X))**2))
    dists = np.sqrt(dists)
    #########################################################################
    #                         END OF YOUR CODE                              #
    #########################################################################
